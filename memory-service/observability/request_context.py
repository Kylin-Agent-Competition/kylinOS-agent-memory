...
各层（gateway/DAO/Worker）日志经 JSON Formatter 自动携带，实现 checklist 6.4
「同一 trace_id 在网关/DAO/Worker 日志可关联」。
...
def set_request_context(*, request_id: str, trace_id: str, method: str) -> None:
    """设置当前线程请求上下文（连接线程处理每个请求时调用）。"""
