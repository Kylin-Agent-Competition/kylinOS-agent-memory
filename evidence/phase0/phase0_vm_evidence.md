...
XDG=/run/user/1000
总计 0
drwxr-xr-x  2 kylin-agent kylin-agent  60  8月22日 18:50 .
drwx------ 13 kylin-agent kylin-agent 400  8月22日 18:50 ..
srw-------  1 kylin-agent kylin-agent   0  8月22日 18:50 memory.sock
srw------- 1 kylin-agent kylin-agent 0  8月22日 18:50 /run/user/1000/kylin-memory/memory.sock
```
...
# exit=0
 ...
 253605 bash -c ps -u kylin-agent -o pid,cmd --no-headers 2>/dev/null | grep -iE 'echo|embed|memory' || echo NO_RELEVANT_PROCESS
 253607 grep -iE echo|embed|memory
```
...
drwx------ 32 kylin-agent kylin-agent 4096  8月22日 18:51 ..
