...
| [D3-B Vector 检索与索引契约 v1](../day3/08_vector_retrieval_contract_v1.md) | 冻结候选，PR #20 Review 返工中 | 冻结 Provider、候选、索引状态、过滤、删除与重建技术语义；D/E 为专业关注点而非累计审批数量 |
...
`APPROVED` 且全部适用 Gate 关闭前，不得标记为正式接受。**
