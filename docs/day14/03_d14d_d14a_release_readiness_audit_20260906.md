...
- 整改状态：`fix/d14a-release-lifecycle@9536746` 已修复 P1-01 至 P1-04，并补充安装失败清理与
  替换 unit/服务/路径的所有权守卫、tar/manifest 身份绑定与完整文件集拒绝；本地发布代码候选 `c0a720c` 已包含这些修复和 L0 守卫测试。
...
## 整改候选（`a253b3d`；本地集成候选代码为 `c0a720c`）
...
候选发布代码提交 `c0a720c9b9d694a8167570d8a3122482da5ee5fe` 已包含 D13E 主线 `4a32e5c`、
