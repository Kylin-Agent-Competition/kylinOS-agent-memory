...
- 基线：`origin/main@b70827c`（2026-09-03 更新：初版基线 0820036，已含 D11D PR #115、C-D11 PR #116、D11B PR #111、D10D PR #120，并新增 C-D12 PR #127、D8D 持久化 PR #128、D12D PR #131；本 PR 分支创建于 0820036，Ready/合并前以最新 main 为准）。
...
- 基线：`origin/main@b70827c`（含 D11D PR #115、C-D11 PR #116、D11B PR #111、D10D PR #120 等）。
...
1. 基线与环境盘点（`origin/main@b70827c`、D11D 统一 VM/交付、C-D11 主演示编排、E 轨业务实现与测试、冻结契约与验收样例）。
