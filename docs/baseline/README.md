...
| `Kylin-runtime-knowledge/VERSION_MAP.md` | **版本对照索引 / Agent 速查入口**（版本对照表 v2，2026-08-17 编制 · 2026-09-01 实测复核 VM 已安装版本：9 项仓库版本对照 + 关键路径/接口 + Agent 使用规则；VM 实际版本/ABI 以环境基线及 L2/L3 evidence 为最终事实依据） |
