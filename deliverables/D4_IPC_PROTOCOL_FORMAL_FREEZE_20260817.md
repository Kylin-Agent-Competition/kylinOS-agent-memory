...
| FRZ-IPC-007 | 方法路由表（活跃 3 项：echo / health / memory.retrieve；memory.store 未实现返回 UNSUPPORTED_METHOD；evidence.record 已按 P0-4 移除） | 2026-08-07（2026-08-17 更正） | ✅ 协议冻结（已签署生效） |
